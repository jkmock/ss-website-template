    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <!-- Icon -->
                <div class="private-travel-image flex items-center justify-center order-2 lg:order-1 translate-y-12 opacity-0 transition-all duration-700">
                ...
                <div class="private-travel-content order-1 lg:order-2 translate-y-12 opacity-0 transition-all duration-700">
                    ...
                    <div class="space-y-6 text-lg text-foreground/70 font-light leading-relaxed">
                        <p>
                            <span class="font-medium text-foreground">5,000+ airports at your disposal.</span> While commercial airlines serve fewer than 500 airports in the United States, private aviation opens access to over 5,000 airports nationwide. Get closer to your actual destination and eliminate hours of ground transportation.
                        </p>
                        <p>
                        ...
                        <p>
                            <span class="font-medium text-foreground">Weather alternatives.</span> When commercial flights are grounded or delayed, we have options. Our pilots can route to alternate airports, depart before weather systems arrive, or wait out delays in the comfort of our FBO rather than a crowded terminal.
                        </p>
                        <p>
                            <span class="font-medium text-foreground">Multi-city efficiency.</span> A typical business day might include Charlotte at 8am, Atlanta at noon, and Nashville by 3pm—impossible on commercial airlines, routine with private charter. Our clients can visit 3-4 cities in a single day.
                        </p>
                    </div>
                </div>
            </div>
