...
<section class="relative h-screen md:h-auto lg:h-screen w-full bg-[#0a1628] flex items-center justify-center">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 md:py-32 lg:py-0">
        <div class="max-w-4xl mx-auto">
            <h1 class="font-serif text-4xl sm:text-5xl lg:text-6xl font-light mb-8 text-white text-center">
                Medical Services
            </h1>
            ...
            <p class="text-xl text-white/80 font-light leading-relaxed mb-8 text-left">
