    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <!-- Content -->
                <div class="medical-content emergency-dispatch-content translate-y-12 opacity-0 transition-all duration-700">
                ...
                <!-- Icon -->
                <div class="medical-image flex items-center justify-center translate-y-12 opacity-0 transition-all duration-700">
