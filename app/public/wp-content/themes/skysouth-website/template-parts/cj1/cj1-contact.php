    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="text-center mb-16 translate-y-12 opacity-0 transition-all duration-1000 ease-out" data-animate>
                ...
                <p class="text-lg font-light leading-relaxed text-gray-700 max-w-2xl mx-auto">
                    Our charter specialists are available 24/7 to help plan your next journey aboard the Citation CJ1.
                </p>
            </div>
