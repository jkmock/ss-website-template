                ...
                <div class="translate-y-12 opacity-0 transition-all duration-1000 ease-out" data-animate>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-3">
                            ...
                            <span class="text-xl font-light text-white/80">Premium leather executive seating with sliding, rotating, and recline capability</span>
                        </div>
                        <div class="flex items-start gap-3">
                            <svg class="w-6 h-6 text-white flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-xl font-light text-white/80">Significant increase in cabin space over CJ1</span>
                        </div>
                        <div class="flex items-start gap-3">
                            <svg class="w-6 h-6 text-white flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
